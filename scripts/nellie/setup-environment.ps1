...
function Create-SymLink {
    Write-Host "`nCreating symbolic link 'extensions\nellie-ref' -> 'extensions\nellie-submodule\extensions\vscode'" -ForegroundColor White
...
$modulePath = Join-Path -Path $currentDir -ChildPath 'extensions\nellie-submodule'
$targetPath = Join-Path -Path $modulePath -ChildPath 'extensions\vscode'
$linkPath = Join-Path -Path $currentDir -ChildPath 'extensions\nellie-ref'
