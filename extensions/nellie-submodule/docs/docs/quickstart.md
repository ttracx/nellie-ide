---
title: ⚡️ Quickstart
description: Getting started with Nellie IDE
...
2. Select Nellie IDE server and log in.

   :::tip

   If login issues arise, use `CMD+SHIFT+P` (`CTRL+SHIFT+P` for Windows) and select "Login to Nellie IDE" to authenticate again.
...
4. Optional: put Nellie IDE in your path so you can open within directories with `pearai .`
