...
export interface IProductConfiguration {
	readonly nellieVersion?: string;
	readonly version: string; // vscode version
	readonly date?: string;
	readonly quality?: string;
	readonly commit?: string; // nellie commit, generated when building and packaging
	...
	readonly nellieHomepageURL?: string;
	readonly nellieLinks?: {
		homepage: string;
		dashboard: string;
		faq: string;
		docs: string;
