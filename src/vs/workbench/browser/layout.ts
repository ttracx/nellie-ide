...
export abstract class Layout extends Disposable implements IWorkbenchLayoutService {
	...
	private nellieOverlayPartView!: ISerializableView;
	private nellieCreatorOverlayPartView!: ISerializableView;
	...
	protected createWorkbenchLayout(): void {
		...
		const nellieOverlayPart = this.getPart(Parts.NELLIEOVERLAY_PART);
		// const nellieCreatorOverlayPart = this.getPart(Parts.NELLIECREATOROVERLAY_PART);
		...
		this.nellieOverlayPartView = nellieOverlayPart;

		// Create a new container for NellieOverlayPart
		const nellieOverlayPartContainer = document.createElement("div");
		nellieOverlayPartContainer.style.position = "absolute";
		nellieOverlayPartContainer.style.top = "0";
		nellieOverlayPartContainer.style.left = "0";
		nellieOverlayPartContainer.style.right = "0";
		nellieOverlayPartContainer.style.bottom = "0";
		nellieOverlayPartContainer.style.zIndex = "-10";
		nellieOverlayPartContainer.style.display = "absolute";
		nellieOverlayPartContainer.classList.add("nellieoverlay-part-container");
		nellieOverlayPartContainer.style.backgroundColor = 'transparent';

		this.mainContainer.appendChild(nellieOverlayPartContainer);
		nellieOverlayPart.create(nellieOverlayPartContainer);
		...
		const viewMap = {
			...
			[Parts.NELLIEOVERLAY_PART]: this.nellieOverlayPartView,
			[Parts.NELLIECREATOROVERLAY_PART]: this.nellieCreatorOverlayPartView,
		};
	...
	layout(): void {
		if (!this.disposed) {
			...
			this.nellieOverlayPartView.layout(this._mainContainerDimension.width, this._mainContainerDimension.height, 0, 0);
	...
	private createGridDescriptor(): ISerializedGrid {
		...
		type StartupLayoutEventClassification = {
			...
			auxiliaryBarVisible: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'Whether or the not the Nellie IDE Side Bar is visible' };
