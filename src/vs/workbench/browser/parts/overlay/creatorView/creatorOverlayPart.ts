...
const CREATOR_VIEW_ID = "nellie.creatorView";
const CREATOR_OVERLAY_TITLE = "nellie.creatorOverlayView";
...
export class CreatorOverlayPart extends Part {
	static readonly ID = "workbench.parts.nelliecreatoroverlay";
	...
	protected override createContentArea(element: HTMLElement): HTMLElement {
		...
		// Create a container for the NellieCreatorOverlayPart that covers the entire screen
		...
		this.overlayContainer.classList.add("nelliecreatoroverlay-part-container");
	...
	toJSON(): object {
		return {
			type: Parts.NELLIECREATOROVERLAY_PART,
		};
	}
}
