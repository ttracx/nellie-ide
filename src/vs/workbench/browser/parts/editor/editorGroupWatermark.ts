...
const openNellieChat: WatermarkEntry = { text: localize('watermark.openNellieChat', "Open Chat"), id: 'nellie.focusContinueInput', when: { native: ContextKeyExpr.has('nellieExtensionLoaded') } };
const bigChat: WatermarkEntry = { text: localize('watermark.nellieBigChat', "Big Chat"), id: 'nellie.resizeAuxiliaryBarWidth', when: { native: ContextKeyExpr.has('nellieExtensionLoaded') } };
const prevChat: WatermarkEntry = { text: localize('watermark.nelliePrevChat', "Previous Chat"), id: 'nellie.loadRecentChat', when: { native: ContextKeyExpr.has('nellieExtensionLoaded') } };
...
export class EditorGroupWatermark extends Disposable {
	...
	private async render(): Promise<void> {
		...
		this.contextKeyService.createKey('nellieExtensionLoaded', true); // Set a context key when the Nellie IDE extension is loaded
	...
	private async renderNoWorkspaceWatermark(): Promise<void> {
		...
		const creatorTextSpan = append(creatorButton, $('span.text', {}, localize('watermark.openCreator', "Nellie IDE Creator")));
