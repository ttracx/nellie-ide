...
class InventoryIcons {
	private static readonly icons: readonly IInventoryIcon[] = [
		{ id: 'agent', icon: 'inventory-creator-icon', label: 'Agent', command: 'nellie-roo-cline.SidebarProvider.focus', width: 80, containerId: 'nellie-roo-cline' },
		{ id: 'chat', icon: 'inventory-chat-icon', label: 'Chat', command: 'nellie.chatView.focus', width: 10, containerId: 'nelliechat' },
		{ id: 'search', icon: 'inventory-search-icon', label: 'Search', command: 'nellie.searchView.focus', width: 75, containerId: 'nelliesearch' },
		{ id: 'memory', icon: 'inventory-memory-icon', label: 'Memory', command: 'nellie.mem0View.focus', width: 85, containerId: 'nelliememory' }
	] as const;
