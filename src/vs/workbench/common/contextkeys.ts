...
export const NellieVisibleContext = new RawContextKey<boolean>('nellieVisible', true, localize('nellieVisible', "Whether the Nellie IDE overlay is visible"));
export const NellieCreatorVisibleContext = new RawContextKey<boolean>('nellieCreatorVisible', true, localize('nellieCreatorVisible', "Whether the Nellie IDE Creator overlay is visible"));
