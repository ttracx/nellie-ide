...
import { auxiliaryBarAllowedViewContainerIDs } from '../services/views/nellie/nellieViewsShared.js';
...
class NellieViewContainersRegistryImpl extends ViewContainersRegistryImpl implements IViewContainersRegistry {
	override registerViewContainer(viewContainerDescriptor: IViewContainerDescriptor, viewContainerLocation: ViewContainerLocation, options?: { isDefault?: boolean; doNotRegisterOpenCommand?: boolean }): ViewContainer {
	  // Register to sidebar instead of aux bar if non nellie integration
	  if (
...
Registry.add(Extensions.ViewContainersRegistry, new NellieViewContainersRegistryImpl());
