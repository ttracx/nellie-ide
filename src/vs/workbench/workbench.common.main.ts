...
registerSingleton(IViewDescriptorService, NellieViewDescriptorService, InstantiationType.Delayed);
...
import { NellieViewDescriptorService } from './services/views/nellie/nellieViews.js';
