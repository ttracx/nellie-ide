...
export const enum Parts {
	...
	NELLIEOVERLAY_PART = 'workbench.parts.nellieoverlay',
	NELLIECREATOROVERLAY_PART = 'workbench.parts.nelliecreatoroverlay'
}
