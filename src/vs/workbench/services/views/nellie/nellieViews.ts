...
import { auxiliaryBarAllowedViewContainerIDs } from './nellieViewsShared.js';

export class NellieViewDescriptorService extends ViewDescriptorService implements IViewDescriptorService {
	constructor(
  ...
  override moveViewContainerToLocation(
    ...
    // Prevent Nellie IDE integrations from moving out of AuxiliaryBar
    if (location !== ViewContainerLocation.AuxiliaryBar && isAllowed()) {
      return;
    }
