...
export enum ThemeSettingDefaults {
	COLOR_THEME_DARK = 'Default Nellie IDE Dark',
	COLOR_THEME_LIGHT = 'Default Nellie IDE Light',
	COLOR_THEME_HC_DARK = 'Default High Contrast',
	COLOR_THEME_HC_LIGHT = 'Default High Contrast Light',

	COLOR_THEME_DARK_OLD = 'Default Nellie IDE Dark',
	COLOR_THEME_LIGHT_OLD = 'Default Nellie IDE Light',
