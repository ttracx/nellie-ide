...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get Started With Nellie"),
		description: localize('gettingStarted.setup.description', "Welcome to Nellie IDE, your AI code editor! Let's personalize your editor and get you familiar with the AI tools."),
		isFeatured: true,
		icon: setupIcon,
		when: '!isWeb',
		...
		content: {
			...
			steps: [
				...
				},
				{
					...
					description: 'Type in the chat box (CMD+L, CTRL+L on Windows) to ask questions about your code. Nellie IDE uses Retrival Augmented Generation to add context to your prompts, but you can also directly reference code by including other files in the chat by adding  @filename. This also works for folders, docs, terminal content, codebase, and more!',
					media: {
						type: 'image',
						path: 'talkToCode.png',
